...
__all__ = ['ComputeV1DiskSnapshotArgs', 'ComputeV1DiskSnapshot']

@pulumi.input_type
class ComputeV1DiskSnapshotArgs:
    def __init__(__self__, *,
                 source_disk_id: pulumi.Input[_builtins.str],
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 metadata: pulumi.Input[Optional['ComputeV1DiskSnapshotMetadataArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parent_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a ComputeV1DiskSnapshot resource.

        :param pulumi.Input[_builtins.str] source_disk_id: Identifier of the source disk. May become stale if the disk is deleted.
        :param pulumi.Input[_builtins.str] description: Arbitrary information about this snapshot provided by user.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels associated with the resource.
        :param pulumi.Input['ComputeV1DiskSnapshotMetadataArgs'] metadata: :
    ...
    @_builtins.property
    @pulumi.getter
    def metadata(self) -> pulumi.Input[Optional['ComputeV1DiskSnapshotMetadataArgs']]:
        """
        :
    ...
    @metadata.setter
    def metadata(self, value: pulumi.Input[Optional['ComputeV1DiskSnapshotMetadataArgs']]):
...
@pulumi.input_type
class _ComputeV1DiskSnapshotState:
    def __init__(__self__, *,
                 ...
                 status: pulumi.Input[Optional['ComputeV1DiskSnapshotStatusArgs']] = None,
                 updated_at: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering ComputeV1DiskSnapshot resources.
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Input[Optional['ComputeV1DiskSnapshotStatusArgs']]:
        return pulumi.get(self, "status")

    @status.setter
    def status(self, value: pulumi.Input[Optional['ComputeV1DiskSnapshotStatusArgs']]):
...
@pulumi.type_token("nebius:index/computeV1DiskSnapshot:ComputeV1DiskSnapshot")
class ComputeV1DiskSnapshot(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 metadata: pulumi.Input[Optional[Union['ComputeV1DiskSnapshotMetadataArgs', 'ComputeV1DiskSnapshotMetadataArgsDict']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parent_id: pulumi.Input[Optional[_builtins.str]] = None,
                 source_disk_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        Create a ComputeV1DiskSnapshot resource with the given unique name, props, and options.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] description: Arbitrary information about this snapshot provided by user.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels associated with the resource.
        :param pulumi.Input[Union['ComputeV1DiskSnapshotMetadataArgs', 'ComputeV1DiskSnapshotMetadataArgsDict']] metadata: :
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ComputeV1DiskSnapshotArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ComputeV1DiskSnapshot resource with the given unique name, props, and options.

        :param str resource_name: The name of the resource.
        :param ComputeV1DiskSnapshotArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ComputeV1DiskSnapshotArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ComputeV1DiskSnapshotArgs.__new__(ComputeV1DiskSnapshotArgs)
        ...
        super(ComputeV1DiskSnapshot, __self__).__init__(
            'nebius:index/computeV1DiskSnapshot:ComputeV1DiskSnapshot',
            resource_name,
            __props__,
            opts,
    ...
    def get(resource_name: str,
            ...
            resource_version: pulumi.Input[Optional[_builtins.float]] = None,
            source_disk_id: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[Union['ComputeV1DiskSnapshotStatusArgs', 'ComputeV1DiskSnapshotStatusArgsDict']]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None) -> 'ComputeV1DiskSnapshot':
        """
        Get an existing ComputeV1DiskSnapshot resource's state with the given name, id, and optional extra
        ...
        __props__ = _ComputeV1DiskSnapshotState.__new__(_ComputeV1DiskSnapshotState)
        ...
        return ComputeV1DiskSnapshot(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def metadata(self) -> pulumi.Output['outputs.ComputeV1DiskSnapshotMetadata']:
        """
        :
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output['outputs.ComputeV1DiskSnapshotStatus']:
        return pulumi.get(self, "status")
