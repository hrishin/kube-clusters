...
class GetComputeV1FilesystemResult:
    ...
    """
    def __init__(__self__, block_size_bytes=None, created_at=None, forbid_deletion=None, id=None, labels=None, metadata=None, name=None, parent_id=None, resource_version=None, size_bytes=None, size_gibibytes=None, size_kibibytes=None, size_mebibytes=None, status=None, type=None, updated_at=None):
