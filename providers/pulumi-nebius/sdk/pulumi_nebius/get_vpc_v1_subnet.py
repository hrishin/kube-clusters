...
class GetVpcV1SubnetResult:
    ...
    """
    def __init__(__self__, created_at=None, id=None, ipv4_private_pools=None, ipv4_public_pools=None, labels=None, metadata=None, name=None, network_id=None, parent_id=None, resource_version=None, route_table_id=None, status=None, updated_at=None):
...
def get_vpc_v1_subnet_output(id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
